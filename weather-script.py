...
weather_xml = urllib2.urlopen('http://graphical.weather.gov/xml/SOAP_server/ndfdSOAPclientByDay.php?whichClient=NDFDgenByDay&lat=38.7197&lon=-77.1546&format=24+hourly&numDays=4&Unit=e').read()
